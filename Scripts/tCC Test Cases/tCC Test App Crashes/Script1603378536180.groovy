...
if (!(WebUI.waitForElementVisible(findTestObject('Page_tCC translationNotes/header_frontintro_Parmed',[('text') : 'TIT front:intro']), 5, FailureHandling.OPTIONAL))) {
...
if (!WebUI.waitForElementVisible(findTestObject('Page_tCC translationNotes/header_frontintro_Parmed',[('text') : '1TI front:intro']), 5, FailureHandling.OPTIONAL)) {
